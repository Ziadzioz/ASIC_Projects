...
# Created by write_sdc on Sat Aug 17 18:02:08 2024
...
group_path -name INOUT  -from [list [get_ports REF_CLK] [get_ports UART_CLK] [get_ports RST] [get_ports test_mode] [get_ports scan_clock] [get_ports scan_reset] [get_ports SI] [get_ports SE] [get_ports RX_IN]]  -to [list [get_ports Tx_OUT] [get_ports Parity_error] [get_ports Stop_error] [get_ports SO]]
group_path -name INREG  -from [list [get_ports REF_CLK] [get_ports UART_CLK] [get_ports RST] [get_ports test_mode] [get_ports scan_clock] [get_ports scan_reset] [get_ports SI] [get_ports SE] [get_ports RX_IN]]
group_path -name REGOUT  -to [list [get_ports Tx_OUT] [get_ports Parity_error] [get_ports Stop_error] [get_ports SO]]
