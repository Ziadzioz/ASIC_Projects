...
# Created by write_sdc on Fri Jul 26 03:52:35 2024
...
group_path -name INOUT  -from [list [get_ports CLK] [get_ports RST] [get_ports party_en] [get_ports data_valid] [get_ports party_typ] [get_ports {P_DATA[7]}] [get_ports {P_DATA[6]}] [get_ports {P_DATA[5]}] [get_ports {P_DATA[4]}] [get_ports {P_DATA[3]}] [get_ports {P_DATA[2]}] [get_ports {P_DATA[1]}] [get_ports {P_DATA[0]}]]  -to [list [get_ports busy] [get_ports Tx_OUT]]
group_path -name INREG  -from [list [get_ports CLK] [get_ports RST] [get_ports party_en] [get_ports data_valid] [get_ports party_typ] [get_ports {P_DATA[7]}] [get_ports {P_DATA[6]}] [get_ports {P_DATA[5]}] [get_ports {P_DATA[4]}] [get_ports {P_DATA[3]}] [get_ports {P_DATA[2]}] [get_ports {P_DATA[1]}] [get_ports {P_DATA[0]}]]
